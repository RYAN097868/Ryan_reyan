...
// Untuk hapus riwayat penjumlahan sebelumnya
...
if (isset($_POST['hitung'])) {
    ...
    switch ($operator) {
        ...
        case 'kali':   $hasil = $angka1 * $angka2; $simbol = "×"; break;
        case 'bagi':
            $simbol = "/";
...
<?php if (!$show_history): ?>
<form method="post">
<tr><td><input type="number" name="angka1" placeholder="Angka pertama" required></td></tr>
<tr><td><input type="number" name="angka2" placeholder="Angka kedua" required></td></tr>
<tr>
<td>
...
<tr><td><button class="btn-hitung" name="hitung">HITUNG</button></td></tr>

<?php if ($hasil !== ""): ?>
<tr><td class="hasil">Hasil: <?= $hasil ?></td></tr>
<?php endif; ?>
</form>
...
<tr>
<td>
<a href="?action=hapus" class="btn-hapus" onclick="return confirm('Hapus semua riwayat?')">Hapus</a>
...
<tr><td style="padding:0"><a href="?" class="btn-back">Kembali</a></td></tr>
<?php endif; ?>
</tbody>
</table>
