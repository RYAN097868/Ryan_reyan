...
<form method="post">
<tr><td>
<input type="text" name="angka1" placeholder="Masukan Angka Pertama" required>
</td></tr>

<tr><td>
<input type="text" name="angka2" placeholder="Masukan Angka Kedua" required>
</td></tr>
